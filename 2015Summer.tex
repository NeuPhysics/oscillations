...
Furthermore, the eigenvalues are not varying very fast and satisfies the condition that

\begin{equation*}
\delta \omega_m = \alpha x,
\end{equation*}

where $\alpha$ is a constant and comes from the first order of the expression.
