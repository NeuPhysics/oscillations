...
& = i \frac{d\hat\Delta}{dx}\left(  \frac{3}{4} \sin\theta_v \sin 2\theta_v - \frac{1}{8} ( (-6+47\cos 2\theta_v - \cos 4\theta_v) \cot^2\theta_v  (-\sin^3\theta_v) ) \hat \Delta + \mathcal{O}(\hat \Delta)^2  \right)
\end{align*}
